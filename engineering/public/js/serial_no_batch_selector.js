erpnext.SerialNoBatchSelector = Class.extend({
	...
	setup: function() {
		...
		this.posting_date = this.frm.doc.posting_date
		// Finbyz Changes END
		this.make_dialog();
			...
			},
			{
				...
				click: () => {
					...
					let numbers = frappe.call({
						method: "engineering.engineering.override.serial_no.auto_fetch_serial_number",
						args: {
							qty: qty,
							item_code: me.item_code,
							warehouse: typeof me.warehouse_details.name == "string" ? me.warehouse_details.name : '',
							//Finbyz Changes START
							posting_date:me.posting_date || null,
							//Finbyz Changes END
...
// frappe.provide("erpnext.SerialNoBatchSelector");
// erpnext.SerialNoBatchSelector = Class.extend({
// 	init: function(opts, show_dialog) {
// 		$.extend(this, opts);
// 		this.show_dialog = show_dialog;
...
// 		this.item_code = opts.item.item_code;
// 		this.warehouse = opts.item.warehouse;
// 		this.qty = opts.item.qty
// 		this.serial_no = opts.item.serial_no
// 		this.make_dialog(opts);
// 		this.on_close_dialog();
// 	},
