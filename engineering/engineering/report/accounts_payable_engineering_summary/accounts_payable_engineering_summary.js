...
frappe.query_reports["Accounts Payable Engineering Summary"] = {
	"filters": [
		{
			"fieldname":"company",
			"label": __("Company"),
	...
	onload: function(report) {
		report.page.add_inner_button(__("Accounts Payable Engineering"), function() {
			var filters = report.get_values();
			frappe.set_route('query-report', 'Accounts Payable Engineering', {company: filters.company});
		});
	}
}
