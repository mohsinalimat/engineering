...
def _execute(filters=None, additional_table_columns=None, additional_query_columns=None):
	...
	for inv in invoice_list:
		...
		row = [inv.posting_date, inv.supplier]
		...
		row += [inv.base_grand_total, flt(inv.base_grand_total, 0), ", ".join(purchase_order), ", ".join(purchase_receipt), company_currency]
		data.append(row)
...
def get_columns(invoice_list, additional_table_columns):
	...
	columns += [
		...
		_("Invoice No") + ":Link/Purchase Invoice:120",
		# {
		# 	"fieldname": "currency",
		# 	"label": _("Currency"),
		# 	"fieldtype": "Data",
	...
	columns = columns +[  #_("Total Tax") + ":Currency/currency:120",
				_("Grand Total") + ":Currency/currency:140",
				_("Rounded Total") + ":Currency/currency:140",
				#_("Outstanding Amount") + ":Currency/currency:120",
				_("Purchase Order") + ":Link/Purchase Order:130",
				_("Purchase Receipt") + ":Link/Purchase Receipt:130",
					]
