...
// 	window.open(window.location.href.split("#")[0] + "#query-report/Accounts Receivable Engineering Summary" + "/?" + "company="+company,"_blank")	
// }
// function view_account_payable_report(company) {
// 	window.open(window.location.href.split("#")[0] + "#query-report/Accounts Payable Engineering Summary" + "/?" + "company="+company,"_blank")	
// }
